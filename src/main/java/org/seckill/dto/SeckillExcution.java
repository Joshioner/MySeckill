...
public class SeckillExcution {
    ...
    //秒杀成功的构造函数
    public SeckillExcution(SeckillStateEnums stateEnums, int seckillId, SuccessKill successKill) {
    ...
    public SeckillExcution(SeckillStateEnums stateEnums, int seckillId) {
        this.stateInfo = stateEnums.getStateInfo();
        this.seckillId = seckillId;
    }
